    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <!--Start Database-->              
                    <?php
                        $sql = "SELECT * FROM `pengajar` ORDER BY `id_pengajar` ";
                      ...
                      <?php
                        ...
                        if($total > 0){
                             while ($row = mysql_fetch_array($query)) {
                                 ...
                                 echo "<td>".($row['nip_pengajar'])."</td>";
                                 echo "<td>".($row['email_pengajar'])."</td>";
                                 echo "<td>".($row['no_telp_pengajar'])."</td>";
                                 echo '<td>
                                <div class="btn-group">
                                ...
                                <a href="edit.php?id='.$row['id_pengajar'].'"><i class="fa fa-pencil"></i> Ubah</a></li></button>
                                <button type="button" tabindex="0" class="dropdown-item">
                                <a onclick="return konfirmasi()" href="hapus.php?id='.$row['id_pengajar'].'">
