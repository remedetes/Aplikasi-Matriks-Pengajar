        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        <a href="jadwalpengajar.php"> <i class="menu-icon fa fa-list-alt"></i>Jadwal Pengajar </a>
                    </li>
                    <li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <!--Start Database-->              
                    <?php
                        $sql = "SELECT * FROM `jadwal_pengajar` ORDER BY `id_jadwal_pengajar` ";
                      ...
                      <?php
                        ...
                        if($total > 0){
                             while ($row = mysql_fetch_array($query)) {
                                 ...
                                 echo "<td>".($row['nama_diklat'])."</td>";
                                 echo "<td>".($row['materi_diklat'])."</td>";
                                ...
                                <a href="edit.php?id='.$row['id_jadwal_pengajar'].'"><i class="fa fa-pencil"></i> Ubah</a></li></button>
                                <button type="button" tabindex="0" class="dropdown-item">
                                <a onclick="return konfirmasi()" href="hapus.php?id='.$row['id_jadwal_pengajar'].'">
